            ...
            <div class="row book">
                ...
                <div class="col-sm-7">
                    ...
                    if (!isset($_SESSION['admin'])) {
                        if (intval($row['quantity']) > 0) {
                            ?>
                            <span href="borrowView.php?bookID=<?php echo $row['bookID'];?>&cap=<?php echo $row['quantity']; ?>" class="a-custom">
                        ...
                        ?>
                        <span href="update.php?bookID=<?php echo $row['bookID'];?>" class="a-custom">
                            <?php echo $row["name"] . "<br/>"; ?>
                            <?php echo $row["caption"]; ?>
                        </span>
                        <?php
                ...
                <div class="col col-sm-3">
                    ...
                    if (!isset($_SESSION['admin'])) {
                        ...
                        ?>
                        <button class="btn borrow" type="submit" name="update" onclick="window.location.href = 'update.php?bookID=<?php echo $row['bookID'];?>';" formmethod="post">Update Book Information</button>
                        <?php
                    }
                    ?>
                </div>
                 ...
                 <div class="row book">
                     ...
                     <div class="col col-sm-3">
                         ...
                         if (isset($_SESSION['student']['id'])) {
                             ...
                             ?>
                             <button class="btn borrow" type="submit" name="update" onclick="window.location.href = 'update.php?bookID=<?php echo $some['bookID'];?>';" formmethod="post">Update Book Information</button>
                             <?php
                         }
                         ?>
                     </div>
