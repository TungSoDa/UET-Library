            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-1">
                        <div class="logo">
                            <a href="index.php">
                                <img src="../assets/img/logo/logo.png" alt="" style="margin-left: -30px" />
                            </a>
                        </div>
                    </div>
                      ...
                      <span>
                        ...
                        NLINE
                                ...
                                <p data-animation="fadeInLeft" data-delay=".6s">
                                    ...
                                    <b>
                                        <a href="https://uet.vnu.edu.vn/" id="uet-page">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-tips mb-50">
                        ...
                        <div class="tips-caption">
                            <h4><a href="#">VNU-LIC chuyển đổi số theo mô hình “Trung tâm Tri thức số”</a></h4>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-tips mb-50">
                        ...
                        <div class="tips-caption">
                            <h4><a href="#">FANPAGE TRUNG TÂM THÔNG TIN - THƯ VIỆN, ĐHQGHN (VNU-LIC) CHÍNH THỨC NHẬN DẤU "TÍCH XANH"</a></h4>
                            <span>Continue Reading</span>
                            <p>March 10, 2020</p>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="single-tips mb-50">
                        ...
                        <div class="tips-caption">
                            <h4><a href="#">ĐHQGHN đứng vị trí 17 Đông Nam Á và trong nhóm 1000 thế giới</a></h4>
                            <span>Continue Reading</span>
                            <p>January 28, 2020</p>
                        </div>
                    </div>
...
<footer class="page-footer" style="background-color: rgb(192, 43, 43);">
    <div class="container">
        <div class="row" style="height: 234px;">
            <div class="col-lg-4">
                <img src="../assets/img/logo/uetLicLogo.png" alt="" style="margin-left: -30px; margin-top: 55px">
            </div>
            <div class="col-lg-8" style="display: flex">
                <div class="col-lg-3">
                    <h5 class="white-text">Category</h5>
                    <ul>
                        <li><a class="grey-text text-lighten-3" href="#!">Introduce</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">Product</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">Service</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">Document</a></li>
                    </ul>
                </div>
                <div class="col-lg-3">
                    <h5 class="white-text">System</h5>
                    <ul>
                        <li><a class="grey-text text-lighten-3" href="#!">Search</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">How to Use</a></li>
                        <li><a class="grey-text text-lighten-3" href="#!">Q&A</a></li>
                    </ul>
                </div>
                <div class="col-lg-6">
                    ...
                    <div class="pane-content">
                        <table border="0" cellpadding="0" cellspacing="0" style="width:100%">
                            <tbody>
                            <tr>
                                <td><img alt="" src="../assets/img/footer/place.png" style="height:16px; width:12px"></td>
                                <td><span style="color:#FFFFFF">5th floor, building C1T, Vietnam National University, 144 Xuan Thuy, Cau Giay, Ha Noi</span></td>
                            </tr>
                            <tr>
                                <td><span style="color:#FFFFFF"><img alt="" src="../assets/img/footer/phone.png" style="height:17px; width:16px"></span></td>
                                <td><span style="color:#FFFFFF">(+84) 024 3754 6545</span></td>
                            </tr>
                            <tr>
                                <td><span style="color:#FFFFFF"><img alt="" src="../assets/img/footer/mail.png" style="height:12px; width:17px"></span></td>
                                <td><span style="color:#FFFFFF"><a href="mailto:lic@vnu.edu.vn" style="color: white">lic@vnu.edu.vn</a></span></td>
                            </tr>
                            </tbody>
                        </table><p>&nbsp;</p>
                    </div>
    ...
    <div class="footer-copyright">
        <div class="container"> © 2021 Subsystem of Library and Information Center, Vietnam National University, Hanoi </div>
    </div>
</footer>
